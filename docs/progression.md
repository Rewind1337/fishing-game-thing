...
Start of Game ────► Digging Worms ────► Fishing Fish ──┴─► Starting a Trip, Choosing a Location               │
                        │ ▲                   │                            │                                  │
                        │ └─┬───────────┬─────┘                            ▼                                  │
                        ▼   ▼         fishloop    ┌──────► Pick until no Worms left or stop Trip              │
                 Finding some Pets                │        │         │            │           │               │
                    │                             │        ▼         ▼            ▼           ▼               │
                    ▼                             │ Fishing Fish  Use Item  Change Gear Change SubLoc         │
   wormloop ◄┬─ Automation                        │        │     Bait, Lure  Rod, Hook        │               │
             │                                    │        └───────────────┬──────────────────┘               │
   fishloop ◄┤                                    │                        ▼                                  │
                                             After Encounter ◄─┬─Chance for Encounter                         │
                                                               │                                              │
                                                               │                                              │
                                                               │                                              │
                                                               │                                              │
                       Blessed | Blessed by the Fishing Gods ◄─┼─► Just Fluff                                 │
                                       (multiplies the catch)  │  (nothing)                                   │
                                                               │                                              │
                                                               │                                              │
                                                               │                                              │
